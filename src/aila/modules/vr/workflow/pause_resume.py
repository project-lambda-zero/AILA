...
* :func:`reset_investigation_atomic`
    ...
    primary branch. Matches the observed contract that
...
async def pause_investigation_atomic(
    ...
    *,
    ...
    async with UnitOfWork() as uow:
        ...
        # branches still marked ``active`` (observed bug on
        # inv <inv-uuid> -- UI rendered the pause acknowledgment but each
...
async def resume_investigation_atomic(
    ...
    *,
    ...
    # in-flight task -- observed live on <inv-uuid> (renzo + wei branches
