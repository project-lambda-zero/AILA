...
_EVIDENCE_FILE = "sources/com/vodafone/selfservis/storage/AuthCache.java"
...
# APK identity meta — mirrored from the operator-supplied Vodafone
# Yanımda fixture so the cover page surfaces a realistic identifier.
