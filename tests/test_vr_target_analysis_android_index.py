...
async def test_index_decompiled_kicks_off_and_records_handles() -> None:
    ...
    current_handles = {
        "android_mcp_decompiled_dir": "/work/decompiled/yanimda",
        "android_mcp_decoded_dir": "/work/decoded/yanimda",
    }
    ...
    assert kickoff_call.kwargs["path"] == "/work/decompiled/yanimda"
    ...
    assert persisted["android_mcp_decompiled_dir"] == "/work/decompiled/yanimda"
    assert persisted["android_mcp_decoded_dir"] == "/work/decoded/yanimda"
