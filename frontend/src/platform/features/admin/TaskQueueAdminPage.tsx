      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
        <div>
          <h1 className="font-mono text-xl font-semibold text-text flex items-center gap-2">
            <Queue className="h-5 w-5 text-accent" />
            Task Queue
          </h1>
          <p className="font-mono text-sm text-text-muted mt-0.5">
            Admin controls for the background task queue. Drain submissions,
            requeue recent failures, and inspect dead-lettered tasks.
          </p>
        </div>
      </div>
