      ...
      <SheetContent side="right" className="w-full sm:max-w-2xl overflow-y-auto">
        ...
        {finding && (
          <div className="flex flex-col gap-5">
            ...
            <AilaCard variant="default" padding="sm">
              <WorkflowActions
            ...
            {/* CVE description */}
            <AilaCard variant="default" padding="sm">
              <SectionLabel>CVE Description</SectionLabel>
            ...
            <AilaCard variant="default" padding="sm">
              ...
              <TextBlock text={finding.rationale} />
            </AilaCard>
            ...
            {finding.details.facts && (
              <AilaCard variant="default" padding="sm">
                ...
                <TextBlock text={finding.details.facts} />
              </AilaCard>
            )}
            ...
            {finding.details.inference && (
              <AilaCard variant="default" padding="sm">
                ...
                <TextBlock text={finding.details.inference} />
              </AilaCard>
            )}

            {/* Recommended action */}
            {finding.details.recommended_action && (
              <AilaCard variant="elevated" padding="sm">
                <SectionLabel>
                  <Wrench size={11} className="inline mr-1" />
                  Recommended Action
                </SectionLabel>
                <TextBlock text={finding.details.recommended_action} />
              </AilaCard>
            )}
            ...
            {finding.details.uncertainty && (
              <AilaCard variant="default" padding="sm">
                ...
                <TextBlock text={finding.details.uncertainty} />
              </AilaCard>
            )}
            ...
            {(finding.details.vendor_statuses?.length ||
              ...
              <AilaCard variant="default" padding="sm">
                <SectionLabel>Vendor Signals</SectionLabel>
                <dl className="grid grid-cols-2 gap-x-4 gap-y-1.5 font-mono text-xs">
                  {!!finding.details.vendor_statuses?.length && (
                    <>
            ...
            {finding.compliance_tags.length > 0 && (
              <AilaCard variant="default" padding="sm">
                <SectionLabel>Compliance Tags</SectionLabel>
