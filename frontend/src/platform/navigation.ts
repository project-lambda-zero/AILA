...
const platformSidebarItems: SidebarItem[] = [
  ...
  // Platform Ops -- god-tier admin surface for sandbox exec,
  // corpus export/stats, and journal deadletter replay.
  {
    id: "platform.admin.platform-ops",
    slot: "sidebar.main",
    label: "Platform Ops",
    to: "/admin/platform-ops",
    order: 84,
    description: "Sandbox, corpus export, journal replay",
    icon: WrenchIcon,
    section: "admin",
    minRole: "admin",
