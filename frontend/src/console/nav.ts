...
export const ADMIN_CATS: { cat: string; items: string[] }[] = [
  ...
  { cat: "platform", items: ["dashboard", "systems", "topology", "topology subnets", "sessions", "notifications", "specialist agents", "platform corpus", "knowledge", "sandbox", "widget layout"] },
